...
namespace _3_PL.Views
{
    public partial class Frm_Product : Form
    {
        ...
        public SizeServices _sizeServices;
        public ColorServices _colorServices;
        public SupplierServices _supplierServices;
        public Guid _id;
        public Category cate;
        public _1_DAL.Models.Size sz;
        public _1_DAL.Models.Color cl;
        public _1_DAL.Models.Supplier su;
        public _1_DAL.Models.Product p;
        public Frm_Product()
        {
            InitializeComponent();
        ...
        public void LoadData()
        {
            ...
            foreach (var x in _productService.GetAll())
            {
                ...
                dtg_view.Rows.Add(x.Id,
                    ...
                    x.MaSp, x.Name, x.Quantity, x.Price, x.Price, x.Description, x.Status == true ? "Hoạt động" : "Không hoạt động");
            }
        }
        ...
        private void dtg_view_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            rbtn_ConHang.Checked = Convert.ToString(dtg_view.Rows[rd].Cells[10].Value) == "Còn Hàng";
            rbtn_HetHang.Checked = Convert.ToString(dtg_view.Rows[rd].Cells[10].Value) == "Hết Hàng";
